...
public class EmployeeController {
    ...
    /**
     * @param employeeDTO
     * @return Redirects to the add employee api in the service layer
     */
    @PostMapping("/add")
    ...
    /**
     * @return Redirects to the retrieve all employees from the service layer
     */
    ...
    /**
     * @param empId
     * @return Redirects to retrieve employee by passing the id in the URL
     */
     ...
     * @param id
     * @param employeeDTO
     * @return Redirects to Update employee by id from the service layer
     */
    ...
    /**
     * @param empId
     * @return Redirects to delete employee by id from the service layer
     */
    ...
    /**
     * @param userDTO
     * @return Redirects to Login the user by providing the credentials from the service layer
     */
